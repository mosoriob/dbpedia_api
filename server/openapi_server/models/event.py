...
class Event(Model):
    ...
    def number_of_people_attending(self):
        """Gets the number_of_people_attending of this Event.

        Description not available  # noqa: E501

        :return: The number_of_people_attending of this Event.
        :rtype: List[int]
        """
    ...
    def number_of_people_attending(self, number_of_people_attending):
        ...
        :param number_of_people_attending: The number_of_people_attending of this Event.
        :type number_of_people_attending: List[int]
        """
    ...
    @property
    def caused_by(self):
        """Gets the caused_by of this Event.

        Description not available  # noqa: E501

        :return: The caused_by of this Event.
        :rtype: List[object]
        """
    ...
    def caused_by(self, caused_by):
        ...
        :param caused_by: The caused_by of this Event.
        :type caused_by: List[object]
        """
    ...
    def label(self, label):
        ...
        :param label: The label of this Event.
        :type label: List[str]
        """
    ...
    def participant(self):
        """Gets the participant of this Event.

        Description not available  # noqa: E501

        :return: The participant of this Event.
        :rtype: List[str]
        """
    ...
    def participant(self, participant):
        ...
        :param participant: The participant of this Event.
        :type participant: List[str]
        """
    ...
    def previous_event(self):
        """Gets the previous_event of this Event.

        Description not available  # noqa: E501

        :return: The previous_event of this Event.
        :rtype: List[object]
        """
    ...
    def previous_event(self, previous_event):
        ...
        :param previous_event: The previous_event of this Event.
        :type previous_event: List[object]
        """
    ...
    @property
    def next_event(self):
        """Gets the next_event of this Event.

        Description not available  # noqa: E501

        :return: The next_event of this Event.
        :rtype: List[object]
        """
    ...
    def next_event(self, next_event):
        ...
        :param next_event: The next_event of this Event.
        :type next_event: List[object]
        """
    ...
    def following_event(self):
        """Gets the following_event of this Event.

        Description not available  # noqa: E501

        :return: The following_event of this Event.
        :rtype: List[object]
        """
    ...
    def following_event(self, following_event):
        ...
        :param following_event: The following_event of this Event.
        :type following_event: List[object]
        """
