...
class DocumentType(Model):
    ...
    @property
    def label(self):
        """Gets the label of this DocumentType.

        short description of the resource  # noqa: E501

        :return: The label of this DocumentType.
        :rtype: List[str]
        """
        return self._label
    ...
    def label(self, label):
        ...
        :param label: The label of this DocumentType.
        :type label: List[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this DocumentType.

        type of the resource  # noqa: E501

        :return: The type of this DocumentType.
        :rtype: List[str]
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this DocumentType.
        :type type: List[str]
        """
