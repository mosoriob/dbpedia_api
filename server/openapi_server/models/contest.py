...
class Contest(Model):
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'Contest':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The Contest of this Contest.  # noqa: E501
        :rtype: Contest
        """
    ...
    def description(self):
        """Gets the description of this Contest.
    ...
    def id(self, id):
        ...
        :param id: The id of this Contest.
        :type id: str
        """
    ...
    @property
    def label(self):
        """Gets the label of this Contest.

        short description of the resource  # noqa: E501

        :return: The label of this Contest.
        :rtype: List[str]
        """
        return self._label
    ...
    def label(self, label):
        ...
        :param label: The label of this Contest.
        :type label: List[str]
        """
