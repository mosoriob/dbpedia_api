...
class NaturalEvent(Model):
    ...
    def __init__(self, number_of_people_attending=None, end_date=None, description=None, caused_by=None, label=None, type=None, participant=None, duration=None, previous_event=None, next_event=None, id=None, following_event=None, start_date=None):  # noqa: E501
        """NaturalEvent - a model defined in OpenAPI
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'NaturalEvent':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The NaturalEvent of this NaturalEvent.  # noqa: E501
        :rtype: NaturalEvent
        """
    ...
    def number_of_people_attending(self):
        """Gets the number_of_people_attending of this NaturalEvent.

        Description not available  # noqa: E501

        :return: The number_of_people_attending of this NaturalEvent.
        :rtype: List[int]
        """
    ...
    def number_of_people_attending(self, number_of_people_attending):
        ...
        :param number_of_people_attending: The number_of_people_attending of this NaturalEvent.
        :type number_of_people_attending: List[int]
        """
    ...
    @property
    def end_date(self):
        """Gets the end_date of this NaturalEvent.

        The end date of the event.  # noqa: E501

        :return: The end_date of this NaturalEvent.
        :rtype: List[str]
        """
    ...
    def end_date(self, end_date):
        ...
        :param end_date: The end_date of this NaturalEvent.
        :type end_date: List[str]
        """
    ...
    def description(self):
        """Gets the description of this NaturalEvent.

        small description  # noqa: E501

        :return: The description of this NaturalEvent.
        :rtype: List[str]
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this NaturalEvent.
        :type description: List[str]
        """
    ...
    @property
    def caused_by(self):
        """Gets the caused_by of this NaturalEvent.

        Description not available  # noqa: E501

        :return: The caused_by of this NaturalEvent.
        :rtype: List[object]
        """
    ...
    def caused_by(self, caused_by):
        ...
        :param caused_by: The caused_by of this NaturalEvent.
        :type caused_by: List[object]
        """
    ...
    @property
    def label(self):
        """Gets the label of this NaturalEvent.

        short description of the resource  # noqa: E501

        :return: The label of this NaturalEvent.
        :rtype: List[str]
        """
        return self._label
    ...
    def label(self, label):
        ...
        :param label: The label of this NaturalEvent.
        :type label: List[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this NaturalEvent.

        type of the resource  # noqa: E501

        :return: The type of this NaturalEvent.
        :rtype: List[str]
        """
        return self._type
    ...
    def type(self, type):
        ...
        :param type: The type of this NaturalEvent.
        :type type: List[str]
        """
    ...
    def participant(self):
        """Gets the participant of this NaturalEvent.

        Description not available  # noqa: E501

        :return: The participant of this NaturalEvent.
        :rtype: List[str]
        """
    ...
    def participant(self, participant):
        ...
        :param participant: The participant of this NaturalEvent.
        :type participant: List[str]
        """
    ...
    def duration(self, duration):
        ...
        :param duration: The duration of this NaturalEvent.
        :type duration: List[float]
        """
    ...
    def previous_event(self):
        """Gets the previous_event of this NaturalEvent.

        Description not available  # noqa: E501

        :return: The previous_event of this NaturalEvent.
        :rtype: List[object]
        """
    ...
    def previous_event(self, previous_event):
        ...
        :param previous_event: The previous_event of this NaturalEvent.
        :type previous_event: List[object]
        """
    ...
    @property
    def next_event(self):
        """Gets the next_event of this NaturalEvent.

        Description not available  # noqa: E501

        :return: The next_event of this NaturalEvent.
        :rtype: List[object]
        """
    ...
    def next_event(self, next_event):
        ...
        :param next_event: The next_event of this NaturalEvent.
        :type next_event: List[object]
        """
    ...
    @property
    def id(self):
        """Gets the id of this NaturalEvent.

        identifier  # noqa: E501

        :return: The id of this NaturalEvent.
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this NaturalEvent.
        :type id: str
        """
    ...
    def following_event(self):
        """Gets the following_event of this NaturalEvent.

        Description not available  # noqa: E501

        :return: The following_event of this NaturalEvent.
        :rtype: List[object]
        """
    ...
    def following_event(self, following_event):
        ...
        :param following_event: The following_event of this NaturalEvent.
        :type following_event: List[object]
        """
    ...
    @property
    def start_date(self):
        """Gets the start_date of this NaturalEvent.

        The start date of the event.  # noqa: E501

        :return: The start_date of this NaturalEvent.
        :rtype: List[str]
        """
    ...
    def start_date(self, start_date):
        ...
        :param start_date: The start_date of this NaturalEvent.
        :type start_date: List[str]
        """
