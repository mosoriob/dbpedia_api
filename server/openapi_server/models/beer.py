...
class Beer(Model):
    ...
    def __init__(self, approximate_calories=None, ingredient=None, taste=None, description=None, type_of_yeast=None, discontinued=None, label=None, type=None, percentage_alcohol=None, creator_of_dish=None, serving_temperature=None, introduced=None, type_of_storage=None, id=None, type_of_grain=None):  # noqa: E501
        """Beer - a model defined in OpenAPI
    ...
    def approximate_calories(self):
        """Gets the approximate_calories of this Beer.

        Approximate calories per serving.  # noqa: E501

        :return: The approximate_calories of this Beer.
        :rtype: List[float]
        """
    ...
    def approximate_calories(self, approximate_calories):
        ...
        :param approximate_calories: The approximate_calories of this Beer.
        :type approximate_calories: List[float]
        """
    ...
    @property
    def ingredient(self):
        """Gets the ingredient of this Beer.
        ...
        :return: The ingredient of this Beer.
        :rtype: List[object]
        """
    ...
    def ingredient(self, ingredient):
        ...
        :param ingredient: The ingredient of this Beer.
        :type ingredient: List[object]
        """
    ...
    @property
    def taste(self):
        """Gets the taste of this Beer.

        Description not available  # noqa: E501

        :return: The taste of this Beer.
        :rtype: List[str]
        """
        return self._taste
    ...
    def taste(self, taste):
        ...
        :param taste: The taste of this Beer.
        :type taste: List[str]
        """
    ...
    def description(self):
        """Gets the description of this Beer.

        small description  # noqa: E501

        :return: The description of this Beer.
        :rtype: List[str]
        """
    ...
    def description(self, description):
        ...
        :param description: The description of this Beer.
        :type description: List[str]
        """
    ...
    def type_of_yeast(self):
        """Gets the type_of_yeast of this Beer.

        Description not available  # noqa: E501

        :return: The type_of_yeast of this Beer.
        :rtype: List[str]
        """
    ...
    def type_of_yeast(self, type_of_yeast):
        ...
        :param type_of_yeast: The type_of_yeast of this Beer.
        :type type_of_yeast: List[str]
        """
    ...
    def discontinued(self):
        """Gets the discontinued of this Beer.

        Description not available  # noqa: E501

        :return: The discontinued of this Beer.
        :rtype: List[str]
        """
    ...
    def discontinued(self, discontinued):
        ...
        :param discontinued: The discontinued of this Beer.
        :type discontinued: List[str]
        """
    ...
    @property
    def label(self):
        """Gets the label of this Beer.

        short description of the resource  # noqa: E501

        :return: The label of this Beer.
        :rtype: List[str]
        """
        return self._label
    ...
    def label(self, label):
        ...
        :param label: The label of this Beer.
        :type label: List[str]
        """
    ...
    @property
    def type(self):
        """Gets the type of this Beer.

        type of the resource  # noqa: E501

        :return: The type of this Beer.
        :rtype: List[str]
        """
        return self._type
    ...
    def percentage_alcohol(self):
        """Gets the percentage_alcohol of this Beer.

        percentage of alcohol present in a beverage  # noqa: E501

        :return: The percentage_alcohol of this Beer.
        :rtype: List[int]
        """
    ...
    def percentage_alcohol(self, percentage_alcohol):
        ...
        :param percentage_alcohol: The percentage_alcohol of this Beer.
        :type percentage_alcohol: List[int]
        """
    ...
    def creator_of_dish(self, creator_of_dish):
        ...
        :param creator_of_dish: The creator_of_dish of this Beer.
        :type creator_of_dish: List[object]
        """
    ...
    def serving_temperature(self):
        """Gets the serving_temperature of this Beer.

        Serving temperature for the food (e.g.: hot, cold, warm or room temperature).  # noqa: E501

        :return: The serving_temperature of this Beer.
        :rtype: List[str]
        """
    ...
    def serving_temperature(self, serving_temperature):
        ...
        :param serving_temperature: The serving_temperature of this Beer.
        :type serving_temperature: List[str]
        """
    ...
    @property
    def introduced(self):
        """Gets the introduced of this Beer.

        Description not available  # noqa: E501

        :return: The introduced of this Beer.
        :rtype: List[str]
        """
    ...
    def introduced(self, introduced):
        ...
        :param introduced: The introduced of this Beer.
        :type introduced: List[str]
        """
    ...
    def type_of_storage(self):
        """Gets the type_of_storage of this Beer.

        Description not available  # noqa: E501

        :return: The type_of_storage of this Beer.
        :rtype: List[str]
        """
    ...
    def type_of_storage(self, type_of_storage):
        ...
        :param type_of_storage: The type_of_storage of this Beer.
        :type type_of_storage: List[str]
        """
    ...
    def type_of_grain(self):
        """Gets the type_of_grain of this Beer.

        Description not available  # noqa: E501

        :return: The type_of_grain of this Beer.
        :rtype: List[str]
        """
    ...
    def type_of_grain(self, type_of_grain):
        ...
        :param type_of_grain: The type_of_grain of this Beer.
        :type type_of_grain: List[str]
        """
