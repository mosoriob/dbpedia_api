...
class Game(Model):
    ...
    def number_of_players(self):
        """Gets the number_of_players of this Game.

        Description not available  # noqa: E501

        :return: The number_of_players of this Game.
        :rtype: List[int]
        """
    ...
    def number_of_players(self, number_of_players):
        ...
        :param number_of_players: The number_of_players of this Game.
        :type number_of_players: List[int]
        """
    ...
    def number_of_professionals(self):
        """Gets the number_of_professionals of this Game.

        number of people who earns his living from a specified activity.  # noqa: E501

        :return: The number_of_professionals of this Game.
        :rtype: List[int]
        """
    ...
    def number_of_professionals(self, number_of_professionals):
        ...
        :param number_of_professionals: The number_of_professionals of this Game.
        :type number_of_professionals: List[int]
        """
    ...
    def number_of_clubs(self):
        """Gets the number_of_clubs of this Game.

        Description not available  # noqa: E501

        :return: The number_of_clubs of this Game.
        :rtype: List[int]
        """
    ...
    def number_of_clubs(self, number_of_clubs):
        ...
        :param number_of_clubs: The number_of_clubs of this Game.
        :type number_of_clubs: List[int]
        """
    ...
    @property
    def equipment(self):
        """Gets the equipment of this Game.

        Description not available  # noqa: E501

        :return: The equipment of this Game.
        :rtype: List[object]
        """
    ...
    def equipment(self, equipment):
        ...
        :param equipment: The equipment of this Game.
        :type equipment: List[object]
        """
    ...
    @property
    def label(self):
        """Gets the label of this Game.

        short description of the resource  # noqa: E501

        :return: The label of this Game.
        :rtype: List[str]
        """
        return self._label
    ...
    def label(self, label):
        ...
        :param label: The label of this Game.
        :type label: List[str]
        """
    ...
    def number_of_people_licensed(self):
        """Gets the number_of_people_licensed of this Game.

        nombre de personnes ayant une license pour pratiquer cette activité  # noqa: E501

        :return: The number_of_people_licensed of this Game.
        :rtype: List[int]
        """
    ...
    def number_of_people_licensed(self, number_of_people_licensed):
        ...
        :param number_of_people_licensed: The number_of_people_licensed of this Game.
        :type number_of_people_licensed: List[int]
        """
