...
class TestSportCompetitionResultController(BaseTestCase):
    """SportCompetitionResultController integration test stubs"""
    ...
    def test_sportcompetitionresults_get(self):
        ...
        response = self.client.open(
            '/v0.0.1/sportcompetitionresults',
            method='GET',
            headers=headers,
    ...
    def test_sportcompetitionresults_id_get(self):
        ...
        response = self.client.open(
            '/v0.0.1/sportcompetitionresults/{id}'.format(id='id_example'),
            method='GET',
            headers=headers)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
