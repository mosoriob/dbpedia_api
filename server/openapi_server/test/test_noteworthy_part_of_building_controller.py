...
class TestNoteworthyPartOfBuildingController(BaseTestCase):
    """NoteworthyPartOfBuildingController integration test stubs"""
    ...
    def test_noteworthypartofbuildings_get(self):
        ...
        response = self.client.open(
            '/v0.0.1/noteworthypartofbuildings',
            method='GET',
            headers=headers,
    ...
    def test_noteworthypartofbuildings_id_get(self):
        ...
        response = self.client.open(
            '/v0.0.1/noteworthypartofbuildings/{id}'.format(id='id_example'),
            method='GET',
            headers=headers)
        self.assert200(response,
                       'Response body is : ' + response.data.decode('utf-8'))
